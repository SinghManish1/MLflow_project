...
Original file is located at
    https://colab.research.google.com/drive/14wCIpjf7xv8LCWfz7XHG3ow2Ol7Vt4oV
"""
...
def run_model(params):
    ...
    with mlflow.start_run(run_name="tracking model") as run:
      model.fit(
        train_x,
        train["label"],
...
ngrok.kill()
NGROK_AUTH_TOKEN="2Sb60OVFgQEjnn8peiaxJTaJBfq_WyZKCye5MC4YuACrox3p"
...
if __name__ == '__main__':
   ...
   epochs = 3
   params = epochs
   (exp_id, run_id) = run_model(params)
